...
ITEMS_FIELD = "cheque_payment_items"
...
class ChequePayment(AccountsController):
	...
	def on_cancel(self):
		...
		# being back in the Issued stage.
		frappe.db.set_value("Cheque Payment", self.name, "cheque_status", "Cancelled", update_modified=False)

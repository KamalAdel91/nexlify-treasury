...
class TreasuryPaymentEntryMixin:
    ...
    def set_amounts(self):
        ...
        self.treasury_expense_currency = self._bank_currency()
    ...
    def _multi_totals(self):
        ...
        lines = [row for row in (self.treasury_expense_items or []) if flt(row.amount)]
    ...
    def _validate_line_currencies(self):
        ...
        for line in self.treasury_expense_items or []:
            if not line.account:
                continue

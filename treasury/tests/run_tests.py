...
def run_all():
    ...
    from treasury.tests import test_cheque_lifecycle, test_unreconcile, test_reconcile_race, test_payment_entry_multi, test_cheque_voucher_refs, test_cheque_surplus_and_cancel  # noqa: E402

    suite = unittest.TestSuite()
    for module in (test_cheque_lifecycle, test_unreconcile, test_reconcile_race, test_payment_entry_multi, test_cheque_voucher_refs, test_cheque_surplus_and_cancel):
